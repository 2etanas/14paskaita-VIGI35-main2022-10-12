            ...
            <input type="hidden" name="filterCollumn" value="<?php echo (isset($_GET["filterCollumn"]) ? $_GET["filterCollumn"]: "visi"); ?>">    
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="sortOrder">
                            <option value="ASC" <?php echo (isset($_GET["sortOrder"]) && $_GET["sortOrder"]=="ASC"? "selected": "" && $_GET["page"]); ?>>ASC</option>
                            <option value="DESC" <?php echo (isset($_GET["sortOrder"]) && $_GET["sortOrder"]=="DESC"? "selected": "" && $_GET["page"]); ?>>DESC</option>
                            <option value="RAND" <?php echo (isset($_GET["sortOrder"]) && $_GET["sortOrder"]=="RAND"? "selected": "" && $_GET["page"]); ?>>RAND</option>
                        </select>   
                    </div>
